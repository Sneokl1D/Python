...
win = tk.Tk()
win.geometry("1080x980")
win.title("VISE and Sneoklid")
...
Button(win, width=8, text='Guess IT!', font=('UBUNTU', 11), command=fun, relief=GROOVE,bg='green').place(relx=0.8, rely=0.3, anchor=CENTER)
